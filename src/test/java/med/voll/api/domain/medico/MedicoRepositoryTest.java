...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var paciente = cadastrarPaciente("Paciente", "paciente@voll.med", "111.111.111-11");
        cadastrarConsulta(medico, paciente, proximaSegundaAs10);

        //when ou act
        var medicoLivre = medicoRepository.escolherMedicoAleatorioLivreNaData(Especialidade
                .CARDIOLOGIA, proximaSegundaAs10);
    ...
    @Test
    @DisplayName("Deveria devolver empty quando não há médico ativo")
